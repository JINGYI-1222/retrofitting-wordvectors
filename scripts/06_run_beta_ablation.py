...
NUM_ITERS = 10
ALPHA = 1.0
BETA_STRATEGIES = ["inverse_degree", "constant"]

EMBEDDING_PATH = PROJECT_ROOT / "models/glove.6B.300d.txt"
RESULTS_DIR = PROJECT_ROOT / "results"
OUTPUT_CSV = RESULTS_DIR / "beta_ablation_results.csv"
OUTPUT_LOG = RESULTS_DIR / "beta_ablation_summary.txt"
...
def main() -> None:
    ...
    log("=== Beta Ablation: GloVe + WordNet Synonym Retrofitting ===")
    ...
    log("=== Beta ablation completed successfully ===")
